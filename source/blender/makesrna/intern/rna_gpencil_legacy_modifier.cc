...
const EnumPropertyItem rna_enum_object_greasepencil_modifier_type_items[] = {
    ...
    {eGpencilModifierType_FollowCurve,
     "GP_FOLLOWCURVE",
     ICON_FORCE_CURVE,
     "Follow Curve",
...
static const EnumPropertyItem modifier_follow_curve_axis_items[] = {
    {GP_FOLLOWCURVE_AXIS_X, "X", 0, "X", "Projection angle around x axis"},
    {GP_FOLLOWCURVE_AXIS_Y, "Y", 0, "Y", "Projection angle around y axis"},
    {GP_FOLLOWCURVE_AXIS_Z, "Z", 0, "Z", "Projection angle around z axis"},
    {0, nullptr, 0, nullptr, nullptr},
};
#endif
...
static StructRNA *rna_GpencilModifier_refine(PointerRNA *ptr)
{
  ...
  switch ((GpencilModifierType)md->type) {
    ...
    case eGpencilModifierType_FollowCurve:
      return &RNA_FollowCurveGpencilModifier;
      /* Default */
...
static void rna_FollowCurveGpencilModifier_material_set(PointerRNA *ptr,
                                                        PointerRNA value,
                                                        ReportList *reports)
{
  FollowCurveGpencilModifierData *fcmd = (FollowCurveGpencilModifierData *)ptr->data;
  Material **ma_target = &fcmd->material;
...
static void rna_def_modifier_gpencilmorphtargets(BlenderRNA *brna)
{
  ...
  prop = RNA_def_property(srna, "invert_layers", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", GP_MORPHTARGETS_INVERT_LAYER);
  RNA_def_property_ui_text(prop, "Inverse Layers", "Inverse filter");
  RNA_def_property_update(prop, 0, "rna_GpencilModifier_update");
  ...
  prop = RNA_def_property(srna, "invert_layer_pass", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", GP_MORPHTARGETS_INVERT_LAYERPASS);
  RNA_def_property_ui_text(prop, "Inverse Pass", "Inverse filter");
  RNA_def_property_update(prop, 0, "rna_GpencilModifier_update");
  ...
  prop = RNA_def_property(srna, "invert_materials", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", GP_MORPHTARGETS_INVERT_MATERIAL);
  RNA_def_property_ui_text(prop, "Inverse Materials", "Inverse filter");
  RNA_def_property_update(prop, 0, "rna_GpencilModifier_update");

  prop = RNA_def_property(srna, "invert_material_pass", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", GP_MORPHTARGETS_INVERT_PASS);
  RNA_def_property_ui_text(prop, "Inverse Pass", "Inverse filter");
  RNA_def_property_update(prop, 0, "rna_GpencilModifier_update");

  prop = RNA_def_property(srna, "invert_vertex", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", GP_MORPHTARGETS_INVERT_VGROUP);
  RNA_def_property_ui_text(prop, "Inverse VertexGroup", "Inverse filter");
  RNA_def_property_update(prop, 0, "rna_GpencilModifier_update");
...
static void rna_def_modifier_gpencilfollowcurve(BlenderRNA *brna)
{
  StructRNA *srna;
  PropertyRNA *prop;

  srna = RNA_def_struct(brna, "FollowCurveGpencilModifier", "GpencilModifier");
  RNA_def_struct_ui_text(
      srna, "Follow Curve Modifier", "Follow Curve modifier to deform stroke points along curves");
  RNA_def_struct_sdna(srna, "FollowCurveGpencilModifierData");
  ...
  RNA_def_property_pointer_funcs(prop,
                                 nullptr,
                                 "rna_FollowCurveGpencilModifier_material_set",
                                 nullptr,
                                 "rna_GpencilModifier_material_poll");
  RNA_def_property_ui_text(prop, "Material", "Material used for filtering effect");
  RNA_def_property_update(prop, 0, "rna_GpencilModifier_update");
  ...
  prop = RNA_def_property(srna, "invert_layers", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", GP_FOLLOWCURVE_INVERT_LAYER);
  RNA_def_property_ui_text(prop, "Inverse Layers", "Inverse filter");
  RNA_def_property_update(prop, 0, "rna_GpencilModifier_update");

  prop = RNA_def_property(srna, "invert_materials", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", GP_FOLLOWCURVE_INVERT_MATERIAL);
  RNA_def_property_ui_text(prop, "Inverse Materials", "Inverse filter");
  RNA_def_property_update(prop, 0, "rna_GpencilModifier_update");

  prop = RNA_def_property(srna, "invert_material_pass", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", GP_FOLLOWCURVE_INVERT_PASS);
  RNA_def_property_ui_text(prop, "Inverse Pass", "Inverse filter");
  RNA_def_property_update(prop, 0, "rna_GpencilModifier_update");
  ...
  prop = RNA_def_property(srna, "invert_layer_pass", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", GP_FOLLOWCURVE_INVERT_LAYERPASS);
  RNA_def_property_ui_text(prop, "Inverse Pass", "Inverse filter");
  RNA_def_property_update(prop, 0, "rna_GpencilModifier_update");
  ...
  RNA_def_property_flag(prop, PROP_EDITABLE | PROP_ID_SELF_CHECK);
  RNA_def_property_pointer_funcs(
      prop, nullptr, "rna_FollowCurveGpencilModifier_object_set", nullptr, nullptr);
  RNA_def_property_update(prop, 0, "rna_GpencilModifier_dependency_update");
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", GP_FOLLOWCURVE_SCATTER);
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", GP_FOLLOWCURVE_DISSOLVE);
  RNA_def_property_ui_text(
      prop,
      "Dissolve",
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", GP_FOLLOWCURVE_REPEAT);
  RNA_def_property_ui_text(
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", GP_FOLLOWCURVE_STROKE_TAIL_FIRST);
  RNA_def_property_ui_text(
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", GP_FOLLOWCURVE_VARY_DIR);
  RNA_def_property_ui_text(prop,
                           "Vary Direction",
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", GP_FOLLOWCURVE_ENTIRE_OBJECT);
  RNA_def_property_ui_text(
...
void RNA_def_greasepencil_modifier(BlenderRNA *brna)
{
  ...
  rna_def_modifier_gpencilfollowcurve(brna);
}
