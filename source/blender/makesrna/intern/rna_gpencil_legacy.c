...
static void rna_def_gpencil_stroke(BlenderRNA *brna)
{
  ...
  RNA_def_property_float_sdna(prop, NULL, "runtime.render_stroke_radius");
  RNA_def_property_clear_flag(prop, PROP_EDITABLE);
  ...
  RNA_def_property_boolean_sdna(
      prop, NULL, "runtime.render_flag", GP_ONDINE_STROKE_IS_OUT_OF_VIEW);
  RNA_def_property_clear_flag(prop, PROP_EDITABLE);
...
static void rna_def_gpencil_layer(BlenderRNA *brna)
{
  ...
  RNA_def_property_boolean_sdna(prop, NULL, "ondine_flag", GP_LAYER_ONDINE_GOUACHE_STYLE);
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_ui_text(
  ...
  RNA_def_property_boolean_sdna(
      prop, NULL, "ondine_flag", GP_LAYER_ONDINE_STROKE_TEXTURE_MIRROR_ANGLE);
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_ui_text(
      prop,
      "Mirror Angle",
