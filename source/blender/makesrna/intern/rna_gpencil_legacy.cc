                                                ...
                                                struct ReportList *UNUSED(reports))
{
  ...
  /* Don't allow setting active morph target to nullptr. */
  if (value.data == nullptr) {
...
static void rna_def_gpencil_point_morph_delta(BlenderRNA *brna)
{
  ...
  srna = RNA_def_struct(brna, "GPencilPointMorphDelta", nullptr);
  ...
  RNA_def_property_float_sdna(prop, nullptr, "rot_quat");
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_array(prop, 4);
  RNA_def_property_ui_text(
...
static void rna_def_gpencil_point_morph_deltas_api(BlenderRNA *brna)
{
  ...
  srna = RNA_def_struct(brna, "GPencilStrokeMorphDeltas", nullptr);
...
static void rna_def_gpencil_stroke_morph(BlenderRNA *brna)
{
  ...
  srna = RNA_def_struct(brna, "GPencilStrokeMorph", nullptr);
  RNA_def_struct_sdna(srna, "bGPDsmorph");
  ...
  RNA_def_property_collection_sdna(prop, nullptr, "point_deltas", "tot_point_deltas");
  ...
  RNA_def_property_int_sdna(prop, nullptr, "morph_target_nr");
  RNA_def_property_clear_flag(prop, PROP_EDITABLE);
  ...
  RNA_def_property_float_sdna(prop, nullptr, "fill_color_delta");
  RNA_def_property_array(prop, 4);
  RNA_def_property_range(prop, 0.0f, 1.0f);
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
...
static void rna_def_gpencil_stroke_morphs_api(BlenderRNA *brna, PropertyRNA *cprop)
{
  ...
  srna = RNA_def_struct(brna, "GPencilStrokeMorphs", nullptr);
  RNA_def_struct_sdna(srna, "bGPDstroke");
...
static void rna_def_gpencil_stroke(BlenderRNA *brna)
{
  ...
  RNA_def_property_collection_sdna(prop, nullptr, "morphs", nullptr);
...
static void rna_def_gpencil_layer_morph(BlenderRNA *brna)
{
  ...
  srna = RNA_def_struct(brna, "GPencilLayerMorph", nullptr);
...
static void rna_def_gpencil_layer_morphs_api(BlenderRNA *brna, PropertyRNA *cprop)
{
  ...
  srna = RNA_def_struct(brna, "GPencilLayerMorphs", nullptr);
  RNA_def_struct_sdna(srna, "bGPDlayer");
...
static void rna_def_gpencil_layer(BlenderRNA *brna)
{
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "ondine_flag", GP_LAYER_ONDINE_USE_STROKE_TEXTURE);
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_ui_text(
      prop, "Use Texture", "Use a texture image to draw strokes on this layer");
  RNA_def_property_update(prop, NC_GPENCIL | ND_DATA, "rna_GPencil_update");

  /* stroke texture image */
  prop = RNA_def_property(srna, "texture_image", PROP_POINTER, PROP_NONE);
  RNA_def_property_pointer_sdna(prop, nullptr, "texture_image");
  RNA_def_property_pointer_funcs(prop, nullptr, "rna_Gpencil_texture_image_set", nullptr, nullptr);
  ...
  /* scale variation */
  prop = RNA_def_property(srna, "texture_scale_variation", PROP_FLOAT, PROP_PERCENTAGE);
  RNA_def_property_float_sdna(prop, nullptr, "texture_scale_variation");
  RNA_def_property_range(prop, 0.0f, 50.0f);
  RNA_def_property_ui_range(prop, 0.0f, 50.0f, 1.0f, 0);
  ...
  RNA_def_property_boolean_sdna(
      prop, nullptr, "ondine_flag", GP_LAYER_ONDINE_STROKE_TEXTURE_MIRROR_ANGLE);
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_ui_text(
      prop,
      "Mirror Angle",
  ...
  RNA_def_property_int_sdna(prop, nullptr, "texture_pos_seed");
  RNA_def_property_range(prop, 0, SHRT_MAX);
  RNA_def_property_int_default(prop, 0);
  RNA_def_property_ui_text(
      prop,
      "Position Seed",
      "Seed for the random position of the texture stencils along the stroke");
  RNA_def_property_update(prop, NC_GPENCIL | ND_DATA, "rna_GPencil_update");
  /** Stroke texture end */
...
static void rna_def_gpencil_morph_target(BlenderRNA *brna)
{
  ...
  srna = RNA_def_struct(brna, "GPencilMorphTarget", nullptr);
  ...
  RNA_def_property_string_funcs(prop, nullptr, nullptr, "rna_GPencilMorphTarget_name_set");
  RNA_def_struct_name_property(srna, prop);
  RNA_def_property_update(prop, NC_GPENCIL | ND_DATA | NA_RENAME, "rna_GPencil_update");
  ...
  RNA_def_property_float_funcs(
      prop, nullptr, "rna_MorphTarget_value_set", "rna_MorphTarget_value_range");
  ...
  RNA_def_property_float_funcs(
      prop, nullptr, "rna_MorphTarget_slider_min_set", "rna_MorphTarget_slider_min_range");
  ...
  RNA_def_property_float_funcs(
      prop, nullptr, "rna_MorphTarget_slider_max_set", "rna_MorphTarget_slider_max_range");
  RNA_def_property_range(prop, -10.0f, 10.0f);
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", GP_MORPH_TARGET_MUTE);
  RNA_def_property_override_flag(prop, PROPOVERRIDE_OVERRIDABLE_LIBRARY);
  ...
  RNA_def_property_float_funcs(
      prop, nullptr, "rna_MorphTarget_layer_order_value_set", "rna_MorphTarget_value_range");
  RNA_def_property_ui_range(prop, -10.0f, 10.0f, 1.0f, 3);
  RNA_def_property_ui_text(
  ...
  RNA_def_property_boolean_funcs(prop, "rna_GPencil_morph_changes_layer_order_get", nullptr);
  RNA_def_property_ui_text(
...
static void rna_def_gpencil_morph_targets_api(BlenderRNA *brna, PropertyRNA *cprop)
{
  ...
  srna = RNA_def_struct(brna, "GreasePencilMorphTargets", nullptr);
  RNA_def_struct_sdna(srna, "bGPdata");
  RNA_def_struct_ui_text(
...
static void rna_def_gpencil_data(BlenderRNA *brna)
{
  ...
  RNA_def_property_collection_sdna(prop, nullptr, "morph_targets", nullptr);
  RNA_def_property_struct_type(prop, "GPencilMorphTarget");
  ...
  RNA_def_property_boolean_funcs(prop, "rna_morph_target_in_edit_mode_get", nullptr);
  RNA_def_property_clear_flag(prop, PROP_EDITABLE);
  ...
  RNA_def_property_float_sdna(prop, nullptr, "runtime.render_zdepth");
  RNA_def_property_clear_flag(prop, PROP_EDITABLE);
