...
static void rna_def_tool_settings(BlenderRNA *brna)
{
  ...
  prop = RNA_def_property(srna, "in_gpencil_morph_edit_mode", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, NULL, "gpencil_flags", GP_TOOL_FLAG_IN_MORPH_EDIT_MODE);
  RNA_def_property_ui_text(
      prop, "In Morph Edit Mode", "When active, a Grease Pencil morph target is being edited");
