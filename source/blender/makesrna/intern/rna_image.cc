...
static void rna_def_image(BlenderRNA *brna)
{
  ...
  /* Ondine. */
  prop = RNA_def_property(srna, "is_ondine_render", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", IMA_ONDINE_RENDER);
  RNA_def_property_ui_text(prop,
                           "Is Ondine Render",
                           "True if this image is generated by the Ondine watercolor renderer");
  RNA_def_property_clear_flag(prop, PROP_EDITABLE);
