...
PYTHON_PILLOW_VERSION_MIN="9.0.0"
PYTHON_PILLOW_VERSION_MEX="10.0.0"
PYTHON_PILLOW_NAME="Pillow"

PYTHON_CAIRO_VERSION="1.21.0"
PYTHON_CAIRO_VERSION_MIN="1.21.0"
PYTHON_CAIRO_VERSION_MEX="1.30.0"
PYTHON_CAIRO_NAME="pycairo"

PYTHON_LLVMLITE_VERSION="0.39.0dev0"
PYTHON_LLVMLITE_VERSION_MIN="0.39.0dev0"
PYTHON_LLVMLITE_VERSION_MEX="0.45.0"
PYTHON_LLVMLITE_NAME="llvmlite"

PYTHON_NUMBA_VERSION="0.56.0"
PYTHON_NUMBA_VERSION_MIN="0.56.0"
PYTHON_NUMBA_VERSION_MEX="0.60.0"
PYTHON_NUMBA_NAME="numba"
...
PYTHON_MODULES_PACKAGES=(
  ...
  "$PYTHON_PILLOW_NAME $PYTHON_PILLOW_VERSION_MIN $PYTHON_PILLOW_VERSION_MEX"
  "$PYTHON_CAIRO_NAME $PYTHON_CAIRO_VERSION_MIN $PYTHON_CAIRO_VERSION_MEX"
  "$PYTHON_LLVMLITE_NAME $PYTHON_NUMBA_VERSION_MIN $PYTHON_NUMBA_VERSION_MEX"
  "$PYTHON_NUMBA_NAME $PYTHON_NUMBA_VERSION_MIN $PYTHON_NUMBA_VERSION_MEX"
)
...
PYTHON_MODULES_PIP=(
  ...
  "$PYTHON_PILLOW_NAME==$PYTHON_PILLOW_VERSION"
  "$PYTHON_CAIRO_NAME==$PYTHON_CAIRO_VERSION"
  "$PYTHON_LLVMLITE_NAME==$PYTHON_LLVMLITE_VERSION"
  "$PYTHON_NUMBA_NAME==$PYTHON_NUMBA_VERSION"
)
...
You may also want to build them yourself (optional ones are [between brackets]):
    ...
    ** (Pillow $PYTHON_PILLOW_VERSION (use pip).
    ** (Pycairo $PYTHON_CAIRO_VERSION (use pip).
    ** (Llvmlite $PYTHON_LLVMLITE_VERSION (use pip).
    ** (Numba $PYTHON_NUMBA_VERSION (use pip).
